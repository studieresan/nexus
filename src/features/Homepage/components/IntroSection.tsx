...
const IconWrapper = ({
  ...
  icon:
    | typeof AiOutlineFundProjectionScreen
    | typeof RiTeamFill
    | typeof FiSend;
  iconSize: number;
}) => (
      ...
      {overlayGroups.map((group, index) => (
        <div key={index} className="col">
          ...
          >
            ...
            <div className={`mb-3 fs-5`}>{group.description}</div>
            <Button
              className="studs-bg"
              size="lg"
              onClick={() => {
...
export function IntroSection({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 className="text-white text-center">Interested in Studs 2024?</h2>
        </div>
        <div className="w-100 text-center">
          <button className="btn btn-primary btn-lg">
            <a
              ...
              target="_blank"
            >
              <h2 className="text-white text-center">Contact Sales</h2>
            </a>
          </button>
        </div>
      </div>
