...
export default function Footer({ appData }: FooterProps): JSX.Element {
  ...
  useEffect(() => {
    if (appData.users) {
      ...
      const projectManagers = (appData.users || []).filter(
        (e) =>
          e.studsYear === highestStudsYear &&
          e.info.role === UserRole.ProjectManager
      );
  ...
  const companyCircle = (img: string) => {
    return (
      ...
      >
        <img
          src={img}
          className="card-img-top img-cover p-3"
          style={{
            width: "100%",
            height: "100%",
            objectFit: "contain",
  ...
  const collaborationsLarge = () => {
    return (
      <div className="d-flex d-lg-block flex-wrap flex-lg-nowrap justify-content-center mb-3">
        ...
        <div
          className="d-flex justify-content-center justify-content-lg-start flex-row gap-3"
          style={{ width: 500 }}
        >
          {companyCircle(fra)}
      ...
      <div className="row row-cols-2 mb-3 justify-content-center">
        ...
        {/* <div className="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-start">
          <div className="d-flex row row-cols-1 row-cols-lg-2">
            ...
            <div
              className="d-none d-lg-flex align-items-left justify-content-center"
              style={{
                width: "50px",
                height: "200px",
